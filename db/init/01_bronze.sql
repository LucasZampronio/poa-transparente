...
-- Controle de Sincronização (Portal da Transparência Federal)
...
-- Registros Brutos (Camada Bronze - Raw Data)
...
-- Benefícios Sociais (Bolsa Família, etc)
